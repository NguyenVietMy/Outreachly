...
public class GitHubProjectSyncService {
    ...
    public boolean shouldSync(UserIntegration integration) {
    ...
    @Transactional
    public int syncProjects(UserIntegration integration) {
        ...
        updateProjectSyncTimestamp(integration);
    ...
    private void updateProjectSyncTimestamp(UserIntegration integration) {
        Map<String, Object> meta = integration.getMetadata();
        if (meta == null) {
            meta = new HashMap<>();
        } else {
        ...
        meta.put("projectSyncLastRun", LocalDateTime.now().toString());
        integration.setMetadata(meta);
