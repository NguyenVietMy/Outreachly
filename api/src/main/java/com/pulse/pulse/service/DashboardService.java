...
public class DashboardService {
    ...
    public List<IntegrationEvent> getRecentActivity(Long userId, int limit) {
        return eventRepo.findByUserIdOrderByEventTimestampDesc(userId, PageRequest.of(0, limit));
    }
